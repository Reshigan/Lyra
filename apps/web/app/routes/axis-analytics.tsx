...
const LABELS: Record<string, Record<string, string>> = {
  ...
  ar: {
    ...
    intro:
      "ما وصل، وما تعطّل، وكم استغرق، وهل صُمد للتاريخ الموعود. الإنتاجية والاستثناءات مستعلَمة، أما رقمَي المدة فمُعتمدان على عيّنة — والبطاقة تقول أيّهما.",
          ...
          <dl className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={term} className="flex flex-col gap-1">
                <dt className="font-ui text-12 uppercase tracking-wider text-subtle">{term}</dt>
