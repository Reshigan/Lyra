...
export const LABELS: Record<string, Record<string, string>> = {
  en: {
    ...
    "open.gross": "Gross amount, in minor units",
    "open.args": "Arguments",
    "open.argsHint":
    ...
    "recon.tolerance": "Tolerance, in minor units",
  ...
  ar: {
    ...
    "open.gross": "المبلغ الإجمالي بالوحدات الصغرى",
    "open.args": "المعاملات",
    ...
    "recon.tolerance": "حد التسامح بالوحدات الصغرى",
