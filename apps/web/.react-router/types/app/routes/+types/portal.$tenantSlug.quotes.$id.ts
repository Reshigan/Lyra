...
type Module = typeof import("../portal.$tenantSlug.quotes.$id.js")

type Info = GetInfo<{
  file: "routes/portal.$tenantSlug.quotes.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../portal.$tenantSlug.quotes.$id.js");
}];
